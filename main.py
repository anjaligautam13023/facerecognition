    ...
    while True:
        ...
        try:
           ...
           if confidence>82:
               ...
               cv2.imshow('facecropped', image)
               # print("do you want to give dataset enter 1")
               # x=int(imput())
               # if(x==1):
               #     while True:
               ...
               #             count = count + 1
               #             face = cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)
               #             cv2.imwrite("E:\\Anjali\\python\\pythonProject\\dataset\\anj{}.png".format(count), face)
               #             cv2.putText(face, str(count), (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 2)
               #             # cv2.imshow('facecropped',face)
               #         else:
